...
/**
 * This data-access class provides the functionality for taking any input text
 * and executing the statements in the text using provided connection
 * properties.
 *
 * @author Bryan Daniel
 */
public class CommonDataAccessor extends BaseDataAccessor implements InputProcessor {
    ...
    public ArrayList<Object> executeInput(String queryString, ConnectionProperties properties) {
        ...
        logger.info("Received input for database.");
        ...
        try {
            ...
            findExecutableStatements(connection, queryString, allResults);
        } catch (SQLException e) {
            logger.error("SQLException occurred during CommonDataAccessor.executeInput.", e);
            allResults.add(e.getMessage());
        } catch (MalformedURLException | ClassNotFoundException | InstantiationException | IllegalAccessException ex) {
            logger.error("Exception occurred during CommonDataAccessor.executeInput.", ex);
        } finally {
